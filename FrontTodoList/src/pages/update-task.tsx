...
export default function UpdateTaskPage() {
  ...
  const [statuses, setStatuses] = useState(['not completed', 'in progress', 'completed']);
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await updateTask(id, {
        ...
        status: taskStatus, // Ajout du statut mis à jour
      });
        ...
        <div className="flex justify-center">
          <div className="w-3/4 bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full sm:w-auto px-5 py-2.5 text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                Update Task
              </button>
            </form>
